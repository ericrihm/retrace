...
**<!-- STATS:tests -->1185<!-- /STATS --> tests** · **<!-- STATS:modules -->23<!-- /STATS --> modules** · **<!-- STATS:loc -->11356<!-- /STATS --> LOC** · **Zero required ML deps**
...
| Metric | Value |
|--------|-------|
| Tests | <!-- STATS:tests -->1185<!-- /STATS --> |
| Coverage | <!-- STATS:coverage -->99%<!-- /STATS --> |
| Modules | <!-- STATS:modules -->23<!-- /STATS --> |
| Lines of code | <!-- STATS:loc -->11356<!-- /STATS --> |
...
cd retrace
pip install -e ".[dev]"
pytest                         # <!-- STATS:tests -->1185<!-- /STATS --> tests, <1s
