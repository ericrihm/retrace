...
**<!-- STATS:tests -->1645<!-- /STATS --> tests** · **<!-- STATS:modules -->29<!-- /STATS --> modules** · **<!-- STATS:loc -->14905<!-- /STATS --> LOC** · **Zero required ML deps**
...
```
src/retrace/                             # <!-- STATS:src_loc -->9912<!-- /STATS --> lines across <!-- STATS:modules -->29<!-- /STATS --> modules
...
| Metric | Value |
|--------|-------|
| Tests | <!-- STATS:tests -->1645<!-- /STATS --> |
| Coverage | <!-- STATS:coverage -->99%<!-- /STATS --> |
| Modules | <!-- STATS:modules -->29<!-- /STATS --> |
| Lines of code | <!-- STATS:loc -->14905<!-- /STATS --> |
...
cd retrace
pip install -e ".[dev]"
pytest                         # <!-- STATS:tests -->1645<!-- /STATS --> tests, <1s
