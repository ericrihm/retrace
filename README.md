...
**<!-- STATS:tests -->1584<!-- /STATS --> tests** · **<!-- STATS:modules -->27<!-- /STATS --> modules** · **<!-- STATS:loc -->14507<!-- /STATS --> LOC** · **Zero required ML deps**
...
```
src/retrace/                             # <!-- STATS:src_loc -->9912<!-- /STATS --> lines across <!-- STATS:modules -->27<!-- /STATS --> modules
...
| Metric | Value |
|--------|-------|
| Tests | <!-- STATS:tests -->1584<!-- /STATS --> |
| Coverage | <!-- STATS:coverage -->99%<!-- /STATS --> |
| Modules | <!-- STATS:modules -->27<!-- /STATS --> |
| Lines of code | <!-- STATS:loc -->14507<!-- /STATS --> |
...
cd retrace
pip install -e ".[dev]"
pytest                         # <!-- STATS:tests -->1584<!-- /STATS --> tests, <1s
