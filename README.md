...
**<!-- STATS:tests -->1321<!-- /STATS --> tests** · **<!-- STATS:modules -->24<!-- /STATS --> modules** · **<!-- STATS:loc -->12559<!-- /STATS --> LOC** · **Zero required ML deps**
...
cd retrace
pip install -e ".[dev]"
pytest                         # <!-- STATS:tests -->1321<!-- /STATS --> tests, <1s
